...
import { Calendar, Users, DollarSign, Clock, Info, MailOpen, Tag } from 'lucide-react';
import { BACKEND_URL } from '../../constants';
import { Link } from 'react-router-dom';

const BookingAdminList = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      let endpoint = `${BACKEND_URL}/api/admin/bookings`;
      if (activeTab !== 'all') {
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {bookings.map((booking) => (
                  <tr key={booking._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{booking.programId?.title || 'Unknown Program'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
...
export default BookingAdminList; 